...
(function() {
    ...
    WebSocket.__initialize = function() {
        if (typeof window != "undefined") {
            window.WEB_SOCKET_SWF_LOCATION = "http://rongcloud-web-sdk.qiniudn.com/WebSocketMainInsecure-0.1.swf";
        }
        ...
        if (!window.WEB_SOCKET_SUPPRESS_CROSS_DOMAIN_SWF_ERROR && !WEB_SOCKET_SWF_LOCATION.match(/(^|\/)WebSocketMainInsecure-0\.1\.swf(\?.*)?$/) && WEB_SOCKET_SWF_LOCATION.match(/^\w+:\/\/([^\/]+)/)) {
            var f = RegExp.$1;
            if (location.host != f) {
